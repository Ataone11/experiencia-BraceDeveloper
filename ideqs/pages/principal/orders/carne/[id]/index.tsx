...
import { getCarnesByOrder } from '../../../../../src/redux/actions/carneActions'
      ...
      <div className="flex w-full h-full">
        ...
        <div className="grid gap-y-[15px] w-full pt-10">
          <div className=" flex gap-5 items-center">
            <button
              onClick={() =>
                router.push(`/administrador/orders/${query?.id}`, undefined, {
                  shallow: true
                })
              }
            ...
            <section className="grid gap-y-[15px] md:flex md:justify-between">
              <p className="font-bold text-textSize6 text-azulPrimary900">
                ...
                <span className="text-neutral-500">
                  {carnesByOrder?.paginador?.totalRegistros} unidades
                </span>
              </p>
