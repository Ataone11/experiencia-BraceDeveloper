...
import informacion from '../../src/assets/empresa/home/informacion.png'
import pdf from '../../src/assets/empresa/home/pdfhome.png'
import punto from '../../src/assets/empresa/home/punto.png'
interface Props {
  title?: string
  description?: string
  image?: any | string
...
const dataSecure: Props[] = [
  {
    ...
    image: ordenador,
    href: 'principal/orders?estado=0'
  },
  {
    id: 2,
    title: 'CONSULTAS',
  ...
  },
  {
    ...
    image: pdf,
    href: 'principal/carne'
  },
  {
    id: 4,
    title: 'PUNTOS DE ATENCIÓN',
    description:
      'Actualice puntos de atención para ID Mobile, agregando la ubicación con la URL de Google Maps',
    image: punto,
    href: 'principal/puntos'
  },
  {
    id: 5,
    title: 'INFORMACIÓN',
    description:
      'Actualice información como pólizas, contratos, y/o demás documentos de los usuarios de ID Mobile',
    image: informacion,
    href: 'principal/informacion'
  }
]
...
const Home: NextPage = () => {
  ...
  return (
    <BasePage title={'Home'}>
      <div>
        <title>{'Home'}</title>
        <div className="hidden md:flex container xl:mx-auto justify-between w-full h-full mx-10 mt-10">
          <div className="mx-5">
        ...
        <div className="flex flex-col justify-center container w-full mx-auto min-h-[75vh] my-auto">
          ...
          <div className="hidden lg:flex h-[345px] flex-col mx-auto md:flex-row justify-center gap-7 my-10 overflow-x-auto scrollbar scrollbar-track-transparent">
