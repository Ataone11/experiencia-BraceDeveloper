...
import MenuAdmin from '../../../../../src/screens/empresa/carne/menu'
...
export default function CarneDetails() {
  ...
  if (user?.rol === USER_ROLES.ENCARGADO) {
    params.sucursal = Number(user?.sucursal)
  }
    ...
    <BasePage title={'Ordenes'}>
      <div className="flex w-full h-full">
        ...
        <div className="hidden md:flex fixed ">
          <MenuAdmin menu={menu} setMenu={Detalle} />
        </div>
          ...
          {!isLoading && (
            <section className="grid gap-y-[15px] md:flex md:justify-between">
              ...
              {carnesByOrder && carnesByOrder.url ? (
                <div className="grid gap-[15px] md:grid-flow-col md:w-[300px]">
