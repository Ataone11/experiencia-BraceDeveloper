...
const dataSecure: Props[] = [
  {
    ...
    image: ordenador,
    href: 'recepcion/orders?estado=0'
  },
  {
    id: 2,
    title: 'REMISIÓN',
  ...
  return (
    <BasePage title={'Home'}>
      <div className="h-full container mx-auto">
        ...
        <div className=" md:hidden flex gap-3 items-start justify-end absolute top-0 right-0 mx-3 pt-20 md:pt-0">
          <Select
            name={'sesion'}
            label={''}
            href={'login'}
        ...
        <div className="flex flex-col justify-center container w-full mx-auto min-h-[75vh] my-auto">
          <div className="flex justify-center text-azulPrimary900 text-textSize4 md:text-textSize2 font-bold w-full">
            <span>MÓDULOS</span>
          </div>
