    ...
    <div className="container py-[63px] mx-auto px-2 md:px-[133px]  w-[90%] flex flex-col">
      ...
      <div className="my-3 md:my-10 flex flex-col-reverse  md:grid md:grid-cols-3 md:gap-2 w-[320px] md:w-[870px] ">
        <div className="flex flex-col">
          ...
          <Inputs
            ...
            action={action}
            value={filtros?.tomador ? filtros?.tomador : ''}
            type={'text'}
            placeholder={'tomador'}
          />
        </div>
      ...
      <div className=" grid grid-cols-1 md:flex gap-x-2   ">
        <div className="flex flex-col gap-y-2">
          ...
          <Select
            name={isChecked ? 'usuario' : 'nombreSucursal'}
            label={''}
            className={
              ' w-[277px] md:w-[568px] h-[36px] md:h-[56px] rounded-md'
            }
            action={action}
            options={isChecked ? usuarios : sucursales}
            nameOptions={isChecked ? 'user' : 'nombre'}
            choose={
              isChecked
                ? filtros?.usuario
                  ? filtros?.usuario
                  : 'Usuarios'
                : filtros?.nombreSucursal
                ? filtros?.nombreSucursal
                : 'Sucursales'
            }
          />
