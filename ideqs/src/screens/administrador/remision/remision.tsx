...
import logoRemision from '../../../assets/administrador/remision/logoRemision.png'
import Button from '../../../components/buttons/buttonPrimaryInvert'
import creado from '../../../assets/administrador/remision/creado.svg'
  ...
  return (
    <div className="container py-[57px] px-[133px]  w-[90%]">
      ...
      <div className="container border-2 border-azulPrimary100 shadow-xl rounded-xl  w-[805px] my-10">
        ...
        <div className="h-[653px] text-center text-grisNeutral300 font-bold ">
          <div className="flex">
            ...
            <div className="m-10">
              <Image src={logoRemision} alt="" className="" />
            </div>
          </div>
          ...
          <div className="mx-20 my-3 flex justify-start gap-x-3">
          ...
          <div className="mx-20 flex justify-start gap-x-3">
