...
import flecha from "../../../assets/flechas/next.svg"
...
const CampaignsActivesRenderD = ({campaignsActives}:Campaigns) =>{
    ...
    if (campaignsActives && campaignsActives?.length > 0) {
        return (
            <div className="hidden md:block md:h-72 md:px-4 md:pt-3 bg-white rounded-rifa overflow-hidden drop-shadow-campaing min-w-[300px]">
...
export default CampaignsActivesRenderD