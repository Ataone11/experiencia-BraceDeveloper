...
import eye from "../../screens/general/icons/eye.svg";
                ...
                <div className="max-w-md">
                    ...
                    <div className="w-full rounded-md p-6 lg:p-0 shadow-[0_3px_7px_0_rgba(0,0,0,0.2)] lg:shadow-none">
                        ...
                        <div className="relative password">
                            <label className="text-primary text-[10px] lg:text-[14px]">Ingresa tu nueva
                                contraseña</label>
                        ...
                        <div className="relative password">
                            <label className="text-primary text-[10px] lg:text-[14px]">Escribe nuevamente tu
                                contraseña</label>
                    ...
                    <div onClick={close}
                         className="text-url text-[10px] lg:text-[14px] cursor-pointer mt-5 flex justify-center"><Link
