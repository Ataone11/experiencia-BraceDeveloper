    ...
    return (
        <div
            ...
            <div
                    ...
                    <form action="">
                        ...
                        </div>
                        {
                            loading ?
                                ...
                                <div className="flex justify-center items-center mt-8">
                                    <button onClick={send}
                                            className="bg-primary-button-bg text-white text-[15px] w-[166px] h-[33px] rounded-[5px]">
                                        Enviar
                                    </button>
                                </div>
                        }
                ...
                <div onClick={close}
                     className="text-[#9955D4] text-[10px] lg:text-[14px] cursor-pointer mt-5 flex justify-center">
