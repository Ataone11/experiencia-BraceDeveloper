...
const RecoverPassword = (props: any) => {
    ...
    function showPassword() {
        const pass = document.getElementById("primary_password");
        ...
        <div
            ...
            <div
                ...
                <div className="max-w-md">
                    ...
                    <p className="text-Principal text-[25px] lg:text-[28px] leading-tight font-semibold text-center">
                        Gracias por llenar tus datos
                    </p>
                    <p className="text-[12px] text-center lg:text-[15px] text-[#707070] my-6">
                        Te enviamos un código al correo {window.sessionStorage.getItem("mail")}. <br/>
                        Crea una nueva contraseña que recuerdes
                    </p>
                    ...
                    <div className="w-full rounded-md p-6 lg:p-0 shadow-[0_3px_7px_0_rgba(0,0,0,0.2)] lg:shadow-none">
                        ...
                        <div className="relative password">
                            ...
                            <input name="password" required
                                   ...
                                   value={newPass.password} id="primary_password"/>
                            ...
                            loading ?
                                ...
                                <div className="flex justify-center items-center mt-10">
                                    <button onClick={onSubmit}
                                            className="bg-Principal text-[15px] text-white w-[166px] h-[33px] rounded-[5px]">
                                        Seguir
                                    </button>
                                </div>
                        }
